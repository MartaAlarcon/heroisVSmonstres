    ...
    public class V2
    {
        public static void Main()
        {
            ...
            switch (level)
            {
                case 1:
                    Console.Clear ();
                    int [] archer = AñadirValoresArqueraNivelFácil();
                    int[] barbarian = AñadirValoresBarbaroNivelFácil();
                    int[] magician = AñadirValoresMagaNivelFácil();
                    int[] druid = AñadirValoresDruidaNivelFácil();
                    int[] monster = AñadirValoresMonstruoNivelFácil();
                    Console.WriteLine(MsgContinue);
                    Console.ReadKey();
                    break;
            }
        }
        public static int[] AñadirValoresArqueraNivelFácil()
        {
        ...
        public static int[] AñadirValoresBarbaroNivelFácil()
        {
        ...
        public static int[] AñadirValoresMagaNivelFácil()
        {
        ...
        public static int[] AñadirValoresDruidaNivelFácil()
        {
        ...
        public static int[] AñadirValoresMonstruoNivelFácil()
        {
